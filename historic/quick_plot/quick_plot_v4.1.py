...
data_set_low=400 #nombre de dernières lignes ignorées dans le fichier de données .dat
...
col_amp=7 #colonne où est indiquée l'amplitude des mesures
