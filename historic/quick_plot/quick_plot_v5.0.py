...
# on sort de tracer tous les élément >nombre_fichiers et <0
...
# si alors il ne reste plus aucun élément dans tracer ou si 0 dans tracer, on trace toutes les courbes
if len(tracer)==0 or (0 in tracer):
...
print('--> '+str(nombre_colonnes)+' to plot per '+extension)
